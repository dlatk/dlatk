...
if __name__ == '__main__':
    ...
    samples = (
        ...
        u'Something </sarcasm> about <fails to break this up> <3 </3 <\\3 mañana vergüenza güenza création blahblahcréation tonterías tonteréas <em class="grumpy">pain</em> <meta name="viewport" content="width=device-width"> <br />',
