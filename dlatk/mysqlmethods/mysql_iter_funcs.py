...
from dlatk.dlaConstants import DEF_ENCODING, MYSQL_ERROR_SLEEP, MAX_ATTEMPTS, warn

def get_db_engine(db_schema, charset=DEF_ENCODING, db_config = '~/.my.cnf', port=3306, stream=False):
    eng = None
    attempts = 0;
    while (1):
        try:
