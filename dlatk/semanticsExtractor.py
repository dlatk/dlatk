...
class SemanticsExtractor(FeatureExtractor):
    ...
    def __init__(self, corpdb, corptable, correl_field, message_field, messageid_field, corpdir):
        #corptable = "_".join(corpdir.split('/')[-2:])
        super(FeatureExtractor, self).__init__(corpdb, corptable, correl_field, message_field, messageid_field)
