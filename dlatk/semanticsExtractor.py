...
class SemanticsExtractor(FeatureExtractor):
    ...
    def __init__(self, db_type, corpdb, corptable, correl_field, mysql_config_file, message_field, messageid_field, corpdir):
        #corptable = "_".join(corpdir.split('/')[-2:])
        super(FeatureExtractor, self).__init__(db_type, corpdb, corptable, correl_field, mysql_config_file, message_field, messageid_field)
