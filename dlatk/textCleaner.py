...
# for addSentTokenizedMessages in messageTransformer
...
Arrows = regex_or(r"(?:<*[-―—=]*>+|<+[-―—=]*>*)", str(u"[\u2190-\u21ff]+".encode('utf-8')))
...
def sentenceNormalization(message, normalizeDict, use_unicode=fwc.DEF_UNICODE_SWITCH):
    ...
    message = remove_urls(message)       # remove URLs      
    ...
    message = remove_handles(message) # regex from NLTK Twitter Tokenizer
    message = reduce_lengthening(message) # regex from NLTK Twitter Tokenizer
